--Begin GroupManager.lua By @ariasudo
...
local function getpro(arg, data)
 if data.photos_[0] then
       ...
       if not lang then
      tdcli.sendMessage(msg.to.id, msg.id_, 1, "`You Have Not Profile Photo...!`\n\n> Group Name : "..(check_markdown(msg.to.title)).."\nGroup ID : "..msg.to.id.."\nName : "..(check_markdown(msg.from.first_name or "----")).."\nUserName : @"..(check_markdown(msg.from.username or "----")).."\nUser ID : "..msg.from.id.."", 1, 'md')
       elseif lang then
...
if matches[2] == 'cmds' or matches[2] == "دستورات" then
			...
			if not lang then
			return "*#cmds* _ρøšт łš αlяeαđч lø¢κeđ_🔒\n*〰〰〰〰〰〰〰〰*\n*øяđeявч*: [@"..(check_markdown(msg.from.username or "----")).."]"
			elseif lang then
...
text = [[
نــرخ فــروش گــروه بــا ربــاتــ
🔖 ʀα∂ι¢αℓвσт  💤

✳️بــرای گــروه های 0 تــا 500 نــفــر ‌
➰1 مــاهه  8 هزار تــومــان
➰3 مــاهه 15 هزار تــومــان

〰〰〰〰〰〰〰
✳️بــرای گــروه های 500 تــا 1000 نــفــر 
➰1 مــاهه  9 هزار تــومــان
➰3 مــاهه  19 هزار تــومــان

〰〰〰〰〰〰〰
✳️بــرای گــروه های 1000 تــا 3000 نــفــر مــاهانــه 
➰1 مــاهه  10 هزار تــومــان 
➰3 مــاهه  27 هزار تــومــان

〰〰〰〰〰〰〰
✳️بــرای گــروه های 3000 تــا 5000  نــفــر مــاهانــه 
➰1 مــاهه  13 هزار تــومــان 
➰3 مــاهه  35  هزار تــومــان

〰〰〰〰〰〰〰
1⃣.تــوجــه داشــتــه بــاشــیــد بــه هیــچ وجــه نــبــایــد ربــات رو از گــروه حــذف ڪــنــیــد و در صــورت داشــتــن هرگــونــه مــشــڪــل فــقــط اون رو از ادمــیــنــی گــروه بــرداریــد و بــه بــنــده مــراجــعــه ڪــنــیــد.

2⃣.لــازم بــه ذڪــره اولــویــت بــصــورت پــرداخــت ڪــارت بــه ڪــارت مــیــبــاشــد.

3⃣.ربــات داعــمــی نــداریــم بــه عــلــت ڪــیــفــیــت و ڪــارای بــالــای ربــات.
________
بــرای خــریــد بــه ایــدی زیــر مــراجــعــه ڪــنــیــد :
